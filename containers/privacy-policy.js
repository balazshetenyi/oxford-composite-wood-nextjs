...
export default function PrivacyContainer() {
    return (
        <div id='separate-page'>
            <h1 style={{ textAlign: 'center' }}>Privacy Policy</h1>
            <p>This Privacy Policy describes how oxfordcompositewood.co.uk (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
            ...
            <ul>
                <li><strong>Personal Information collected: </strong>name, billing address, shipping address, payment information (including credit card numbers)</li>
            ...
            <ul>
                <li>We use Shopify to power our online store. You can read more about how Shopify uses your Personal Information here: <a href='https://www.shopify.com/legal/privacy' traget='_blank' rel='noopener noreferrer'>https://www.shopify.com/legal/privacy</a>.</li>
                <li>We may share your Personal Information to comply with applicable laws and regulations, to respond to a subpoena, search warrant or other lawful request for information we receive, or to otherwise protect our rights.</li>
            </ul>
            <h2>Behavioural Advertising</h2>
            <p>As described above, we use your Personal Information to provide you with targeted advertisements or marketing communications we believe may be of interest to you. For example: </p>
            <ul>
                <li>We use Google Analytics to help us understand how our customers use the Site. You can read more about how Google uses your Personal Information here: <a href='https://policies.google' target='_blank' rel='noopener noreferrer'>https://policies.google.com/privacy?hl=en</a>.You can also opt-out of Google Analytics here: <a href='https://tools.google.com/dlpage/gaoptout' target='_blank' rel='noopener noreferrer'>https://tools.google.com/dlpage/gaoptout</a>.</li>
            ...
            <h2>Contact</h2>
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at oxfordcompositewood@gmail.com or by mail using the details provided below: </p>
            <p>Oxford Composite Wood Ltd, MIlton Road , Didcot , OX11 7HH, United Kingdom</p>
            <p>Last updated: 30.09.2020</p>
